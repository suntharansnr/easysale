...
function StoreHomePage({ className = "", store }) {
  return (
    <DIV
      ...
      backgroundImg={
        store.shop_theme
          ? base_url+ '/' + store.shop_theme.welcome_banner
          ...
          <div className="shop-description-row row justify-content-around ">
            ...
            <div className="col-9  description-text">
              <div className="text text-color-grey-ori  font-1-8 ">
                <ShowMoreTxt
                  className="font-1-8 text-center"
                  showMoreTextClassName={
                    "text-color-primary  text-color-link   "
                  }
                  paragraph={
                    store.shop_theme ? store.shop_theme.footer_about_us : ""
                  }
                  words={90}
                />
              </div>
            ...
            <div className="col-2 box-img">
              <div className=" w-100">
                <img
                  src={
                    store.shop_theme
                      ? base_url+ '/' + store.shop_theme.logo
                      : "/assets/img-not-found.jpg"
                  }
                  alt=""
                  className="w-100"
